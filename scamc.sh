...
TSTS='false true example_pass self filesystems gcc intel git svn cmake autotools librsb octave lrztools matlab spack python-3.0.1 gromacs timeout hls-testsuite mumps_cmuc3'
PASS=''
FAIL=''
POFL=''
FOFL=''
